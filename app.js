    ...
    <div class="pix-step" id="pixStepValor">
      <div class="field">
        ...
        <div class="pix-valor-wrap">
          ...
          <input type="number" id="pixValor" min="1" step="0.01" placeholder="0,00" class="pix-valor-input"
      ...
      <button class="btn btn-primary btn-full" id="btnGerarQr" onclick="gerarQrCode()">✨ Gerar QR Code</button>
    </div>
...
async function gerarQrCode() {
  const valor = parseFloat(el$('pixValor')?.value?.trim());
            ...
            <div class="a-card">
              ...
              <div class="admin-grid-2">
                <div>
                  ...
                  <div class="field">
                    <label>Chips da tela de login <small style="color:var(--muted)">(um por linha)</small></label>
                    ...
                    <div class="icon-config-box">
                      ...
                      <div class="icon-config-opts">
                        ...
                        <div class="upload-area" style="padding:12px" onclick="el$('cfgIconFile').click()">
                          ...
                          <p style="font-size:11px;margin:0">Carregar uma imagem</p>
